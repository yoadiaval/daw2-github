...
export class EmpleadoComponent implements CanComponentDeactivate {
  ...
  guardaEmpleado(): void {
    if (this.empleadoForm!.valid) {
      ...
      this._empleadosService.modificaEmpleado(this.id,
  ...
  /*Valida la clase del html
  para evitar tanto codigo en el input, si lo tengo que poner 
  directamente en el elemento htmlseria
  [ngClass]="{'is-valid': descModel.touched &&
descModel.valid,'is-invalid': descModel.touched && !descModel.valid}"
  */
